  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden">
        ...
        >
          <div className="relative w-full h-auto flex items-center justify-center z-10">
            {/* Left slide - more offset */}
            <div className="absolute left-[-60px] top-[-60px]">
              <div className="w-[240px] aspect-[16/9] rounded-2xl overflow-hidden bg-black/20 backdrop-blur-sm border border-white/10 shadow-2xl">
                <Image
